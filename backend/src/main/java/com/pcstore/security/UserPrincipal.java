...
public class UserPrincipal implements OAuth2User, UserDetails {
    ...
    public static UserPrincipal create(TaiKhoan user) {
        List<GrantedAuthority> authorities = user.getVaiTros().stream()
    ...
    public static UserPrincipal create(TaiKhoan user, Map<String, Object> attributes) {
    ...
    public String getUsername() {
        return username; // Spring Security uses username
    }
